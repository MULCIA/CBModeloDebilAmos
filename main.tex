...
Se representa el bucle principal como una f'ormila y se busca que dicha f'ormula satisfaga las siguientes propiedades:

\begin{itemize}
    \item La f'ormila es verdadera antes de comenzar el bucle.
