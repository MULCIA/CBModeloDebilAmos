...
\begin{equation*}
  \theta(i) \equiv \forall \sigma \in T_{i-1} \forall r (1 \leq r \leq i \to ((\sigma)_{r},(\sigma)_{r+1}) \in E)
\end{equation*}
...
\textbf{Teorema 2.1.} $\forall i (2 \leq i \leq n \to \theta(i))$. Es decir, la f'ormula $\theta$ es un invariante del
bucle principal.
...
$\forall r (1 \leq r < i \to ((\sigma)_{r},(\sigma)_{r+1}) \in E)$. Por tanto, $\sigma_{i+1}$ es un camino del grafo $G$.
...
\textbf{Teorema 2.2.} $\forall i (2 \leq i \leq n \to \delta(i))$. Es decir, la f'ormula $\delta$ es un invariante del
bucle principal.

La demostraci'on, por inducci'on d'ebil sobre $i$ es: sea $\sigma \in T_{0}$ tal que $\sigma$ codifica un camino
hamiltoniano de $G$. Entonces $\forall r (1 \leq r \leq n \to ((\sigma)_{r},(\sigma)_{r+1}) \in E)$. Luego,
